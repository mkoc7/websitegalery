...
:root {
  ...
  --accent-foreground: oklch(0.99 0.003 70);
  ...
  --radius: 0.625rem;
  --sidebar: oklch(0.97 0.005 70);
  --sidebar-foreground: oklch(0.20 0.02 50);
  --sidebar-primary: oklch(0.45 0.12 40);
  --sidebar-primary-foreground: oklch(0.99 0.003 70);
...
@theme inline {
  --font-sans: var(--font-sans), 'Inter', 'Inter Fallback';
  --font-serif: var(--font-serif), 'Playfair Display', 'Playfair Display Fallback';
